            ...
            <main className="bg-background">
                ...
                <section className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
                    <div className="grid md:grid-cols-3 gap-8 mb-16">
                        <div className="border border-border rounded-lg p-8 text-center hover:bg-muted/30 transition-colors">
                            ...
                            <p className="text-sm text-muted-foreground mt-1">Mon-Fri, 10am-6pm EST</p>
                        </div>
                        ...
                        <div className="border border-border rounded-lg p-8 text-center hover:bg-muted/30 transition-colors">
                            ...
                            <p className="text-muted-foreground">hello@luxeatelier.com</p>
